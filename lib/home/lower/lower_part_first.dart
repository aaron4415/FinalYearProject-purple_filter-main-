...
class _LowerPartFirstState extends State<LowerPartFirst> {
    ...
    Widget build(BuildContext context) {
        ...
        Widget progressBar = LinearPercentIndicator(
            ...
            percent: 0.8, // = TODO: Change this to a variable, the value should be identical to the disinfectionPercentage
        ...
        Widget disinfectPercentage = SizedBox(
            child: BorderedText(
                ...
                strokeColor: Colors.blue,
                child: const Text(
                    '<75%', // TODO: Change this to a double variable that chages the number as progress continues
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 21.0,
                        fontStyle: FontStyle.italic,
